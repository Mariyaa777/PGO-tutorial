class LiquidCar implements Car {
    private String id;
    private double capacity;
    private double maxCargoWeight;
    private double currentCargoWeight;

    public LiquidCar(String id, double capacity, double maxCargoWeight) {
        this.id = id;
    ...
    public boolean loadCargo(double weight, boolean isLiquid, boolean isDangerous, double temp) {
        if (!isLiquid || isDangerous || currentCargoWeight + weight > maxCargoWeight) {
            return false;
        }
